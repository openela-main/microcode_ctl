...
# Last available 06-55-06 (revision 0x4003605). Upstream removed it in 20250512.
Source50:       https://github.com/intel/Intel-Linux-Processor-Microcode-Data-Files/raw/microcode-20240312/intel-ucode/06-55-06
...
# SPR-EE (CPUID 06-8f-08) has latency spikes on 0x2b000603 and newer microcode
# https://issues.redhat.com/browse/RHEL-86425
# While ES1/ES2 (stepping U0) have CPUID of 06-8f-05, the issue
# has been reported against the production version of the CPUs (stepping U1/L0),
# that only have 06-8f-08 CPUID, https://cdrdv2.intel.com/v1/dl/getContent/784461
#
# 06-8f-08 revision 0x2b0005c0:
Source190:      https://github.com/intel/Intel-Linux-Processor-Microcode-Data-Files/raw/microcode-20240514/intel-ucode/06-8f-08
Source191:      06-8f-08_readme
Source192:      06-8f-08_config
Source193:      06-8f-08_disclaimer
...
Patch0004:      0004-releasenote.md-fix-incorrect-platform-mask-for-RPL-H.patch
Patch0005:      0005-releasenote.md-fix-stepping-for-RPL-S.patch
Patch0006:      0006-releasenote.md-add-missing-06-ba-03-e0-to-the-new-mi.patch
Patch0007:      0007-releasenote.md-remove-the-duplicating-06-9e-0c-22-re.patch
Patch0008:      0008-releasenote.md-fix-old-revisions-for-06-8e-09-10-and.patch
Patch0009:      0009-releasenote.md-add-old-revisions-for-06-be-00-11-06-.patch
Patch0010:      0010-releasenote.md-eliminate-trailing-white-space.patch
Patch0011:      0011-releasenote.md-add-information-about-updates-and-rem.patch
Patch0012:      0012-releasenote.md-add-information-about-06-ba-08-microc.patch
Patch0013:      0013-releasenote.md-fix-whitespace-in-microcode-20240531-.patch
Patch0014:      0014-releasenote.md-use-None-for-the-empty-list-of-new-pl.patch
Patch0015:      0015-releasenote.md-add-missing-old-revision-in-microcode.patch
Patch0016:      0016-releasenote.md-use-new-lines-consistently.patch
...
# Re-instantiate the removed 06-cf-01 microcode filee, based on the existing
# microcode files that also have matching signatures in the extended signature
# header.
cp -vn intel-ucode/06-cf-02 intel-ucode/06-cf-01

# Include the last available revision 0x4003605 of 06-55-06 microcode,
# before it has been removed in microcode-20250512 release.
cp -v "%{SOURCE50}" intel-ucode/

# Replacing SPR-EE (CPUID 0x806f8) microcode with pre-20241112 version
mv -v intel-ucode/06-8f-08 intel-ucode-with-caveats/
cp -v "%{SOURCE190}" intel-ucode/
...
# caveats
install -m 644 "%{SOURCE100}" "%{SOURCE110}" "%{SOURCE191}" \
...
# SPR-EE caveat
%define spr_inst_dir %{buildroot}/%{caveat_dir}/intel-06-8f-08/
install -m 755 -d "%{spr_inst_dir}/intel-ucode"
install -m 644 intel-ucode-with-caveats/06-8f-08 -t "%{spr_inst_dir}/intel-ucode/"
install -m 644 "%{SOURCE191}" "%{spr_inst_dir}/readme"
install -m 644 "%{SOURCE192}" "%{spr_inst_dir}/config"
install -m 644 "%{SOURCE193}" "%{spr_inst_dir}/disclaimer"
...
- Fix typo in /usr/share/microcode_ctl/ucode_with_caveats/intel-06-8f-08/config
  (RHEL-123517)
- Update Intel CPU microcode to microcode-20251111 release (RHEL-128195)
  - Addition of 06-ae-01/0x97 microcode at revision 0x1000273;
  - Update of 06-8f-04/0x87 (SPR-SP E0/S1) microcode (in
    intel-ucode/06-8f-07) from revision 0x2b000643 up to 0x2b000650;
  ...
  - Update of 06-8f-04/0x87 (SPR-SP E0/S1) microcode (in
    intel-ucode/06-8f-08) from revision 0x2b000643 up to 0x2b000650;
  - Update of 06-8f-05/0x10 (SPR-HBM B1) microcode (in
    intel-ucode/06-8f-08) from revision 0x2c000401 up to 0x2c000410;
  - Update of 06-8f-05/0x87 (SPR-SP E2) microcode (in
    intel-ucode/06-8f-08) from revision 0x2b000643 up to 0x2b000650;
  ...
  - Update of 06-97-05/0x07 (ADL-S 6+0 K0) microcode (in
    intel-ucode/06-97-02) from revision 0x3a up to 0x3d;
  - Update of 06-bf-02/0x07 (ADL C0) microcode (in intel-ucode/06-97-02)
    from revision 0x3a up to 0x3d;
  ...
  - Update of 06-97-02/0x07 (ADL-HX/S 8+8 C0) microcode (in
    intel-ucode/06-97-05) from revision 0x3a up to 0x3d;
  ...
  - Update of 06-9a-04/0x80 (ADL-P 2+8 R0) microcode (in
    intel-ucode/06-9a-03) from revision 0x437 up to 0x43a;
  - Update of 06-9a-03/0x80 (ADL-P 6+8/U 9W L0/R0) microcode (in
    intel-ucode/06-9a-04) from revision 0x437 up to 0x43a;
  ...
  - Update of 06-ba-02/0xe0 (RPL-H 6+8/P 6+8 J0) microcode (in
    intel-ucode/06-ba-03) from revision 0x4129 up to 0x6133;
  ...
  - Update of 06-be-00/0x19 (ADL-N A0) microcode from revision 0x1d up
    to 0x1e;
  - Update of 06-97-02/0x07 (ADL-HX/S 8+8 C0) microcode (in
    intel-ucode/06-bf-02) from revision 0x3a up to 0x3d;
  - Update of 06-97-05/0x07 (ADL-S 6+0 K0) microcode (in
    intel-ucode/06-bf-02) from revision 0x3a up to 0x3d;
  ...
  - Update of 06-bf-07/0x07 microcode (in intel-ucode/06-bf-02) from
    revision 0x3a up to 0x3d;
  - Update of 06-97-02/0x07 (ADL-HX/S 8+8 C0) microcode (in
    intel-ucode/06-bf-05) from revision 0x3a up to 0x3d;
  - Update of 06-97-05/0x07 (ADL-S 6+0 K0) microcode (in
    intel-ucode/06-bf-05) from revision 0x3a up to 0x3d;
  ...
  - Update of 06-c6-02/0x82 (ARL-HX 8P/S B0) microcode (in
    intel-ucode/06-c5-02) from revision 0x119 up to 0x11a;
  ...
  - Update of 06-c5-02/0x82 (ARL-H A1) microcode (in intel-ucode/06-c6-02)
    from revision 0x119 up to 0x11a;
  ...
  - Update of 06-cf-01/0x87 (EMR-SP A0) microcode (in
    intel-ucode/06-cf-02) from revision 0x210002b3 up to 0x210002c0;
...
* Tue May 27 2025 Denys Vlasenko <dvlasenk@redhat.com> - 4:20250512-1
...
- Update Intel CPU microcode to microcode-20250512 release, addresses
  ...
  (RHEL-91227, RHEL-91242, RHEL-91234):
...
- Update Intel CPU microcode to microcode-20250211 release, addresses
  ...
  CVE-2024-37020, CVE-2024-39279, CVE-2024-39355, CVE-2024-36293 (RHEL-79184,
  RHEL-79185, RHEL-79188, RHEL-79189, RHEL-79191, RHEL-79193, RHEL-79203):
...
- Update Intel CPU microcode to microcode-20241112 release, addresses
  CVE-2024-21820, CVE-2024-21853, CVE-2024-23918, CVE-2024-23984 (RHEL-67335):
  - Update of 06-8f-04/0x87 (SPR-SP E0/S1) microcode (in
...
* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 4:20240910-2
